...
// The market clock lives in lib/riyadh-time.ts (2026-09 engineering audit
// ARCH-04); re-exported so the booking callers keep one import.
import { addDays, nowMinutesInRiyadh, todayInRiyadh } from '@/lib/riyadh-time';
export { addDays, nowMinutesInRiyadh, todayInRiyadh };
