...
export function RatingSummary({ aggregate, locale }: RatingSummaryProps) {
  ...
  if (count === 0 || average === null) {
    return (
      <div className="border-sarat-black/12 rounded-card flex flex-col items-center gap-3 border px-6 py-12 text-center">
    ...
    <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:gap-12">
      <div className="flex flex-col gap-2">
        <div className="flex items-baseline gap-2">
          <span className="text-display-fixed">{averageDisplay}</span>
