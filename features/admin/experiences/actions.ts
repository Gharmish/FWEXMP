  ...
  try {
    ...
    await db
      ...
      .set({
        ...
        // Blank story → NULL: the guest-facing section hides itself.
        storyEn: input.storyEn.length > 0 ? input.storyEn : null,
        storyAr: input.storyAr.length > 0 ? input.storyAr : null,
