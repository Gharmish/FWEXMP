  ...
  return (
    <form onSubmit={onSubmit} role="search" className="relative w-full sm:w-72">
      ...
      <input
        ...
        className="rounded-button border-sarat-black/20 bg-fog-white text-sarat-black placeholder:text-sarat-black-600 h-11 w-full [border-width:0.5px] ps-10 pe-4 text-base"
      />
    </form>
  );
}
