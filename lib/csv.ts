 ...
 * correctly. Cells starting with a formula trigger (= + - @, plus a
 * leading TAB or CR — OWASP lists both) are prefixed with a quote to
 * defuse CSV-injection in spreadsheet apps.
 */
