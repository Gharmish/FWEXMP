 ...
 * (rounded-input, 1px hairline, focus ring from the global
  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        'rounded-input border-sarat-black/45 text-sarat-black w-full resize-y border bg-white px-4 py-3 text-base',
