  ...
  return (
    <div className="flex items-stretch gap-2" dir="ltr">
      ...
      <select
        ...
        className={cn(
          'rounded-input border-sarat-black/20 text-sarat-black h-11 w-36 shrink-0 truncate border bg-white ps-3 pe-2 text-base',
      ...
      <input
        ...
        aria-describedby={describedBy}
        className={cn(
          'rounded-input border-sarat-black/20 text-sarat-black h-11 w-full min-w-0 flex-1 border bg-white px-4 text-base',
