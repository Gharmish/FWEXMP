...
/**
 * Gharmish Input — rounded-input, 44px tall, 1px hairline border.
  ...
  return (
    <input
      ...
      className={cn(
        ...
        'rounded-input border-sarat-black/45 text-sarat-black h-11 w-full border bg-white px-4 text-base',
