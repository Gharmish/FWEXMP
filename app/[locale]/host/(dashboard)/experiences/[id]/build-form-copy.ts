...
export function buildExperienceFormCopy(
  ...
  return {
    ...
    descriptionArLabel: t('descriptionArLabel'),
    arOptionalHint: t('arOptionalHint'),
    // Raw template — filled client-side (functions can't cross the RSC boundary).
    counter: t('counter', { count: '{count}', max: '{max}' }),
    categoryLabel: t('categoryLabel'),
    durationLabel: t('durationLabel'),
    durationHoursLabel: t('durationHoursLabel'),
    durationMinutesLabel: t('durationMinutesLabel'),
    priceLabel: t('priceLabel'),
    priceHint: t('priceHint'),
    priceYouKeep: t('priceYouKeep'),
    priceVatIncluded: t('priceVatIncluded'),
    groupSizeLabel: t('groupSizeLabel'),
    minAgeLabel: t('minAgeLabel'),
    minAgeHint: t('minAgeHint'),
    ...
    inclusionsArLabel: t('inclusionsArLabel'),
    inclusionsArPlaceholder: t('inclusionsArPlaceholder'),
    whatToBringLabel: t('whatToBringLabel'),
    whatToBringPlaceholder: t('whatToBringPlaceholder'),
    whatToBringHint: t('whatToBringHint'),
    whatToBringArLabel: t('whatToBringArLabel'),
    whatToBringArPlaceholder: t('whatToBringArPlaceholder'),
    ...
    unsaved: t('unsaved'),
    unsavedReviewNote: t('unsavedReviewNote'),
    lockedReview: t('lockedReview'),
    lockedArchived: t('lockedArchived'),
    errors: {
      ...
      fields: {
        ...
        titleEither: t('errors.fields.titleEither'),
        titleArInvalid: t('errors.fields.titleArInvalid'),
        descriptionShort: t('errors.fields.descriptionShort'),
        descriptionLong: t('errors.fields.descriptionLong'),
        descriptionArInvalid: t('errors.fields.descriptionArInvalid'),
