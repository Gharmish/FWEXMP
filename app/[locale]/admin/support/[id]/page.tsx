...
export default async function AdminSupportThreadPage({
  ...
  const copy = {
    ...
    nudge: t('support.thread.nudge'),
    nudgePending: t('support.thread.nudgePending'),
    nudgeHint: t('support.thread.nudgeHint'),
    errors: {
      ...
      no_template: t('support.thread.errors.no_template'),
