...
export async function generateMetadata({
  ...
  return {
    title: locale === 'ar' ? 'ضريبة القيمة المضافة' : 'VAT',
  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      {report.vatEnabled && report.unstampedPaidCount > 0 && (
        <div className="border-al-qatt-red/40 bg-al-qatt-red-100 text-al-qatt-red-800 rounded-card flex items-start gap-3 [border-width:0.5px] p-4 text-sm">
